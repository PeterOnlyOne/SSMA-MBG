...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.getS() != null) {
            sql.VALUES("S#", "#{s,jdbcType=DECIMAL}");
        }
        ...
        if (record.getSage() != null) {
            sql.VALUES("SAGE", "#{sage,jdbcType=DECIMAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getS() != null) {
            sql.SET("S# = #{record.s,jdbcType=DECIMAL}");
        }
        ...
        if (record.getSage() != null) {
            sql.SET("SAGE = #{record.sage,jdbcType=DECIMAL}");
        }
